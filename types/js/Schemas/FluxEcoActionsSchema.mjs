 ...
 * @property {Object.<string, FluxEcoActionParameterSchema>} parameters - arameters - The parameters of the action, with each key being a string and the value being a FluxEcoActionParameterSchema.
